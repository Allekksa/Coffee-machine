    ...
    <div class="container">
      <div class="row coffee-machine" id="coffee">
        ...
        <div class="col-6 coffee-oper">
          <div class="row p-3"><!--внутренний отступ со всех четырех сторон 3 рема padding-->
            <div class="col-6">
              <div class="display">
                ...
                <div class="coffee-cup">
                  <img class="d-none" src="img/americano.png" alt=""><!--d-none прячет кружку изначально-->
                </div>
            </div>
            <div class="col-6">
              <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Баланс" aria-label="Имя получателя" aria-describedby="basic-addon2" readonly> <!--можно ничего не вписывать в атрибут после равно, это == readonly=true , у этого атрибудт булиевое значение-->
